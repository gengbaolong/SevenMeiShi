...
import com.seven.gengbaolong.sevenmeishi.comment.CommentTextView;
import com.seven.gengbaolong.sevenmeishi.utils.DateUtils;

import cn.bingoogolapple.badgeview.BGABadgeImageView;

/**
 * Created by gengbaolong on 2017/3/13.
 */
        ...
        holder.mImageViewThumbUp.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(entity.getLiked()){
                    ...
                    entity.setLiked_count(entity.getLiked_count());
                    holder.mImageViewThumbUp.setImageResource(R.mipmap.ic_thumb_up_gray_18dp);
