...
import com.seven.gengbaolong.sevenmeishi.adapter.CommentsAdapter;
...
import com.seven.gengbaolong.sevenmeishi.presenter.impl.PlayVideoPresenterImpl;
import com.seven.gengbaolong.sevenmeishi.support.recyclerview.OnRecycleViewScrollListener;
import com.seven.gengbaolong.sevenmeishi.support.recyclerview.TopScrollListener;
...
public class VideoPlayActivity extends BaseCompatActivity implements PlayVideoView, SwipeRefreshLayout.OnRefreshListener, CommentsAdapter.OnCommentItemClickListener{
    ...
    public void initView(){
        setUpCommonBackToolBar(R.id.tool_bar, " ");
