...
//            onBindViewHolder((VH)holder, position);// java.lang.StackOverflowError: stack size 8MB  at com.seven.gengbaolong.sevenmeishi.adapter.BaseLoadMoreRecyclerAdapter.onBindViewHolder(BaseLoadMoreRecyclerAdapter.java:69)
    ...
    public abstract void onBindItemViewHolder(final VH holder, int position);//具体的Adapter会实现这个方法,如MediasAdapter，CommentsAdapter等
